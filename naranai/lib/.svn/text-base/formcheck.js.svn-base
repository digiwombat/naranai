/*
	...
	About:
		formcheck.js v.1.4.1 for mootools v1.2 - 12 / 2008
	...
	*/
	addError : function(obj) {
		...
		if (obj.element) {
			...
			if (Browser.Engine.trident && Browser.Engine.version == 5 && this.options.display.errorsLocation < 2) {
				obj.element.setStyle('opacity', 1);
			} else {
				new Fx.Tween(obj.element, {'duration' : this.options.display.fadeDuration}).start('opacity', 1);
			}
		}
	...
	*/
	removeError : function(obj) {
		...
		if (this.options.display.errorsLocation >= 2 && obj.element)
			new Fx.Tween(obj.element, {'duration' : this.options.display.fadeDuration}).start('height', 0);
		if (Browser.Engine.trident && Browser.Engine.version == 5 && this.options.display.errorsLocation == 1 && obj.element) {
			obj.element.destroy();
			obj.element = false;
		} else if (obj.element) {
